function TechDiversityGender(this: any) {
    ...
    this.draw = function() {
        ...
        const lineHeight = (height - this.layout.topMargin) / this.data.getRowCount();
    ...
    this.mapPercentToWidth = function(percent: number) {
      return map(percent,
                 0,
                 100,
                 0,
